...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO anuncio ( titulo , descripcion, fechaPublicacion, horaPublicacion, persona, img_anuncio) VALUES ( :titulo, :descripcion, :fechaPublicacion, :horaPublicacion, :persona, :img_anuncio)";
