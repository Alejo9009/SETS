                        ...
                        <div class="appointment"
                            ...
                            <center>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    <a href="editarsolicitudbbq.php?ID_Apartamentooss=<?= htmlspecialchars($solicitud['ID_Apartamentooss']) ?>" type="button" class="btn btn-success">Editar</a>
                                    <form action="./servidor-zonas/elimin bbq.php" method="POST">
