    ...
    <div class="container">
        <section class="login-content">
            ...
            <div class="container">
                ...
                <form action="mott.php" method="POST">
                    <input type="hidden" name="id_parking" value="<?php echo $idSolicitud; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="numParqueadero" value="<?= htmlspecialchars($solicitud['id_parking']) ?>" required class="form-control">
                    </div>
