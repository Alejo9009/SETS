...
$imagenPerfilPredeterminada = "../../img/perfil.png";
...
try {
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $imagenesPorRol = [
            1111 => "../../frontend-web/admin/img/ajustes.png", 
            2222 => "../../frontend-web/seguridad/img/guarda.png", 
            3333 => "../../frontend-web/residente/img/resi.png" 
        ];
        ...
        $sql = "INSERT INTO registro (idRol, PrimerNombre, SegundoNombre, PrimerApellido, SegundoApellido, apartamento, Correo, Id_tipoDocumento, numeroDocumento, tipo_propietario, telefonoUno, telefonoDos, Usuario, Clave, imagenPerfil) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $base_de_datos->prepare($sql);
        $stmt->execute([$idRol,  $PrimerNombre,$SegundoNombre, $PrimerApellido,$SegundoApellido,$apartamento, $Correo, $Id_tipoDocumento, 
        $numeroDocumento, $tipo_propietario, $telefonoUno, $telefonoDos, $Usuario,
            $Clave, $imagenPerfil
        ]);
