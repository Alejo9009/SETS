...
<body>
    ...
    <main>
        ...
        <section>
                ...
                <tbody>
                    ...
                    try {
                        ...
                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            echo '<td>
                            <a href="eliminar_usuario.php?id=' . htmlspecialchars($id) . '" class="btn btn-success" onclick="return confirm(\'¿Estás seguro de que deseas editar este usuario?\')">Editar</a>
                        </td>';
        
                        echo '<td>
                        <a href="eliminar_usuario.php?id=' . htmlspecialchars($id) . '" class="btn btn-danger" onclick="return confirm(\'¿Estás seguro de que deseas eliminar este usuario?\')">ELIMINAR</a>
                    </td>';
            ...
            <a href="inicioprincipal.php" class="btn btn-success">
