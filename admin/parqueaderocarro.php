    ...
    <main>
        ...
        <div class="container">
            <div id="carro" class="tab-content active">
                ...
                <center><a href="horariocarro.php" class="small-btn" style="text-decoration: none;">Ver Horario Parqueadero Visitante</a> </center>
            </div>
            <br>
            <div class="d-flex justify-content-between">
                
                <a href="inicioprincipal.php" class="btn btn-outline-success" style=" font-size:25px;">
